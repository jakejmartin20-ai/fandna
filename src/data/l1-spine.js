// FanDNA - l1 spine add-on, INERT stage (s42). Re-exports the base module unchanged and exports
// NO spineScoring, so l1 scores exactly as it does live. Flipping this file (adding spineScoring)
// turns the league onto the spine atomically - both the engine and the quiz read it from here.
import { moduleQuestions as m, scoring as s } from "./ligue1";
