// FanDNA CFB data (sport six, fingerprint path). Same export shape as nfl.js / mlb.js / nba.js / nhl.js.
...
const nearlyGot = {
  ...
  "KSU": {
    ...
    "NEB": "Nebraska knows your plains loyalty and your love of the in-state walk-on made good, wrapped in a far grander history. The difference is the ceiling: theirs held titles, yours held a miracle. If the devotion is to fallen royalty rather than a hard-won climb, you are describing Nebraska.",
  ...
  "WIS": {
    ...
    "NEB": "Nebraska matches your Midwestern physicality and your massive, devoted crowd, wrapped around a glory era yours never quite reached. The difference is the trophy case: theirs holds five titles, yours holds Rose Bowls and respect. If the loyalty is to fallen royalty, you are describing Nebraska.",
  ...
  "BOI": {
    ...
    "HAW": "Hawaii knows your kind of mid-major magic and your love of a wide-open dream season, the far-flung team that shocked the sport. If the breakthrough is an island Cinderella run rather than a sustained power, you are describing Hawaii.",
  ...
  "MSU": {
    "OKS": "Oklahoma State knows your exact chip, the loyal, hard-working program long cast as its state's little brother. If the defiance wears orange and answers to Oklahoma rather than green answering to Michigan, lean Oklahoma State.",
