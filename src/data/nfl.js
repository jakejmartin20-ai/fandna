...
const teams = {
  ...
  "NE": {
    ...
    "emoji": "🇺🇸",
    "color": "#002244",
    "tagline": "Six titles in eighteen years, and you took the whole league's contempt as proof you were right.",
  ...
  "LAR": {
    ...
    "emoji": "🐏",
    "color": "#003594",
    "tagline": "You are the only fans to win it all in three different cities, always chasing the brightest lights.",
...
const milestones = {
  ...
  "DET": ["Four NFL championships, all before the Super Bowl era, the last in 1957.", "Barry Sanders, ten seasons of impossible cuts, retired at the top with the record in reach.", "The zero and sixteen season in 2008, the only winless full season in league history.", "The long climb back under Dan Campbell, deep playoff runs and a city daring to believe again.", "A franchise that dates to 1930, still chasing its first Super Bowl."],
  ...
  "CLE": ["Four NFL championships between 1946 and 1964, all before the Super Bowl existed.", "Jim Brown, nine seasons, many call him the greatest back ever, and never once on a losing team.", "The Drive and The Fumble, the 1980s AFC Championship heartbreaks Cleveland never forgets.", "The franchise deactivated in 1996 and reborn in 1999, the name and colors kept by the fans.", "The longest active title drought in the NFL, faith tested and never broken."],
  ...
  "NYJ": ["Super Bowl III, the guarantee, Joe Namath backing his words in the game that legitimized the AFL.", "The only title, and one of the most important upsets in football history.", "The longest active playoff drought in North American major sports.", "Curtis Martin and Darrelle Revis, greats who could not lift the franchise back to the top.", "Broadway Joe, the swagger that still defines the Jets more than fifty years on."],
