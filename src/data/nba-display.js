// FanDNA - NBA display half (lazy-loaded, s83 code-split A'). Heavy result-stage prose
// split from nba.js; merged onto SPORT_DATA via loadSportDisplay(). The engine never reads these.
