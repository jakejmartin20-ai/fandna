...
const teamEdge = {
  ...
  LEN: {community:"a region's club before anything else, where the belonging is total", rootedness:"the coalfield the country forgot, and a stadium bigger than the town it stands in", emotion:"Bollaert on a big day, one of the great atmospheres in France", loyalty:"a bond that held through decline and the lower divisions, because leaving was never a thought"},
