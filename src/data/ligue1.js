...
const nearlyGot = {
  PSG:{
    ...
    NIC:"You and Nice alike are backed by serious modern money and believe you ought to matter on the biggest stage. The difference is the distance traveled: you have spent your way to the summit of Europe, while Nice still waits for the investment to turn into something that counts. The money worked for you. Nice is still waiting to find out whether it works at all.",
  ...
  MON:{
    PFC:"There's real kinship here: you run on serious money and a cool, businesslike plan rather than raw passion. The difference is the maturity: you are an established, beautifully run operation with eight titles behind it, while Paris FC is the same idea at the very beginning, still buying its way toward relevance. Paris FC is buying what you already own.",
  ...
  LEN:{
    ...
    BRE:"The two of you are smaller clubs powered by a tight, devoted local community rather than money. The difference is the volume: you turn a whole mining region into one of France's great atmospheres, while Brest does its overachieving quietly, happily, at the calm edge of Brittany. Brest overachieves in a whisper. You do it at a volume that carries for miles.",
  ...
  TOU:{
    LIL:"You and Lille are cool, data-smart operations that overachieve through good recruitment rather than spending. The difference is the trophy: Lille proved the smart model can win the whole league, while you aim more modestly, to punch above your means as the football club in a rugby city. Lille took the model all the way to a title. You are still proving football belongs in your city.",
  ...
  NIC:{
    ANG:"Angers and you are clubs without a recent golden age, getting on with the business of mattering in the present. The difference is the resource: you are Riviera glamour with new money and the hope it buys relevance, while Angers is the unfashionable battler scrapping for survival with nothing behind it. You are waiting for the money to mean something. Angers never had any to wait on.",
    TRO:"You and Troyes are mid-table clubs more defined by your circumstances than by passion or a deep local roar. The difference is the direction: you are backed by serious money and waiting to climb, while Troyes is a development cog in a global machine, riding up and down the divisions. Troyes exists to feed something bigger. You intend to become something bigger.",
  ...
  AJA:{
    STR:"The two of you are deeply rooted clubs that trust the patient road over the quick fix. The difference is where the patience comes from: yours is the calm continuity of one town and one manager across forty years, while Strasbourg's was forged in a fan-led rebuild from bankruptcy. Strasbourg's patience was forged in a crisis. Yours was never interrupted by one.",
  ...
  TRO:{
    ANG:"You and Angers are clubs that live with the divisions shifting beneath you, never settled for long. The difference is the reason: you churn as a development cog in a global empire, talent passing through, while Angers yo-yos because it is an unfashionable battler scrapping to survive. You churn because that is the plan. Angers churns because it has no choice.",
  ...
  LEM:{
    LOR:"Lorient and you are small clubs whose loyal towns matter more than any trophy. The difference is the journey: you fell all the way to the amateurs and clawed back, feeling every survived season deeply, while Lorient simply rides the tide with the even calm of a port. Lorient has never had to fear the end. You have already seen it.",
