...
const nearlyGot = {
  ...
  MAR:{
    ...
    LYO:"Lyon and you are big clubs who feel every result intensely and carry real history. The difference is the temperament: you live on raw Mediterranean emotion and volatility, while Lyon broods over a lost dynasty with a colder, more wounded pride. You wear the weight loud, on raw Mediterranean nerve, while Lyon wears it aching over a lost dynasty.",
    LEM:"Start with the overlap. You love this club with a fervor that survives the worst the game can throw at you. The difference is the size of the story: you are a giant who conquered Europe, while Le Mans is a small club that simply refused to die and clawed its way back. Same devotion, one on the summit and one grateful just to be here.",
  },
  MON:{
    PFC:"There's real kinship here: you run on serious money and a cool, businesslike plan rather than raw passion. The difference is the maturity: you are an established, beautifully run operation with eight titles behind it, while Paris FC is the same idea at the very beginning, still buying its way toward relevance. You are the proven operation with eight titles; Paris FC is the same idea still buying its way toward relevance.",
    ...
    TRO:"Here's the common ground: you operate as smart, structured clubs more than emotional ones, comfortable being run like a business. The difference is the wealth: you are the rich principality that keeps the best young talent until the giants pay up, while Troyes is a modest development outpost in a much larger empire. Same clinical approach, one at the top and one feeding it.",
  },
  LIL:{
    REN:"You and Rennes are well-run clubs with smart academies and real ambition. The difference is the budget: you win titles by being sharper than richer clubs, the cool head spending nothing, while Rennes has serious money behind it and the restlessness that comes with it. You win titles by outsmarting richer clubs and spending nothing; Rennes has the money and the restlessness that trails it.",
  ...
  LEN:{
    ...
    BRE:"The two of you are smaller clubs powered by a tight, devoted local community rather than money. The difference is the volume: you turn a whole mining region into one of France's great atmospheres, while Brest does its overachieving quietly, happily, at the calm edge of Brittany. You turn a whole mining region into one of France's great atmospheres, while Brest overachieves in a contented hum at the edge of Brittany.",
    LEM:"Le Mans and you are working towns whose people refused to let the club fade, loyalty carrying you through the hard years. The difference is the depth of the crisis: you stayed devoted through decline and the lower divisions, while Le Mans went all the way to the amateurs before climbing back. Same faithful support, one through decline and one through near-death.",
  },
  BRE:{
    STR:"You and Strasbourg are unpretentious clubs whose strength is a community that simply turns up, season after season. The difference is the origin story: you are the happy overachiever gatecrashing the big time from the edge of Brittany, while Strasbourg's bond was forged rebuilding a bankrupt club from the fifth tier. Yours is a joyful climb from the edge of Brittany; Strasbourg's was a hard resurrection from the fifth tier.",
    ...
    LIL:"The two of you are calm, sensibly run clubs that quietly outperform your means. The difference is the standing: Lille is an established champion of France, a serious club with a title in the cabinet, while you are the little overachiever just thrilled to be gatecrashing the party. One of you is a proven champion, the other just glad to be gatecrashing.",
  },
  REN:{
    LIL:"Lille and you are smartly run clubs with strong academies and an eye for a bargain. The difference is the temperament: you are backed by real money and restless for the next step, never quite content, while Lille is the cooler operator who already has the title and feels no need to raise its voice. You are backed and restless for more. Lille has the trophy and the calm that comes with it.",
    BRE:"You and Brest are Breton clubs with deep roots in your region and a loyal local heart. The difference is the ambition: you are the backed capital club hungry for Europe and impatient for more, while Brest is the smaller, happier neighbor delighted simply to be punching above its weight. You are the backed capital club hungry for Europe, while Brest is the happy neighbor glad just to punch above its weight.",
    STR:"The near-miss makes sense: you draw real strength from a fierce regional identity and a devoted support. The difference is the project: you are an ambitious, well-funded club chasing the top half and Europe, while Strasbourg's whole story is the fans who rebuilt it from nothing and the comeback that still defines it. You are well-funded and looking up at Europe; Strasbourg's whole story is the fans who rebuilt it, and it keeps looking back at that.",
  },
  STR:{
    BRE:"You and Brest alike are grounded, unpretentious clubs carried by a community that keeps showing up. The difference is the road traveled: your bond was forged rebuilding a dead club from the fifth tier, a hard resurrection, while Brest is the happy overachiever enjoying a sudden, gentler rise. Yours was earned rebuilding a dead club from the fifth tier. Brest's came from a sudden, happy rise.",
    AJA:"The two of you are deeply rooted clubs that trust the slow, patient way over the quick fix. The difference is the source of the patience: yours was forged in a fan-led rebuild from bankruptcy, while Auxerre's is the calm continuity of one town and one manager across forty years. Yours was forged in a fan-led rebuild from bankruptcy, while Auxerre's is the calm continuity of one town and one manager across forty years.",
    LEN:"Lens and you are fierce regional clubs whose supporters are the whole identity. The difference is the legend: your bond was forged rebuilding a dissolved club from the bottom, while Lens carries the inherited roar of the coalfield, blood and gold passed down for generations. Same unbreakable support, one through rescue and one through heritage.",
  },
  TOU:{
    LIL:"You and Lille are cool, data-smart operations that overachieve through good recruitment rather than spending. The difference is the trophy: Lille proved the smart model can win the whole league, while you aim more modestly, to punch above your means as the football club in a rugby city. Lille proved the smart model can win the whole league; you aim only to punch above your means as the football club in a rugby city.",
    ...
    BRE:"The two of you are level-headed clubs that overachieve without much noise. The difference is the means: you run a sharp, data-led model in a rugby city, engineering your edge, while Brest is the small Breton club whose edge is simply a tight, happy community. Same understated overachieving, one by design and one by togetherness.",
  },
  NIC:{
    ANG:"Angers and you are clubs without a recent golden age, getting on with the business of mattering in the present. The difference is the resource: you are Riviera glamour with new money and the hope it buys relevance, while Angers is the unfashionable battler scrapping for survival with nothing behind it. You are Riviera glamour with new money and the hope it buys, while Angers scraps for survival with nothing behind it.",
    TRO:"You and Troyes are mid-table clubs more defined by your circumstances than by passion or a deep local roar. The difference is the direction: you are backed by serious money and waiting to climb, while Troyes is a development cog in a global machine, riding up and down the divisions. You are backed and waiting to climb; Troyes is a development cog riding the divisions in a global machine.",
  ...
  ANG:{
    ...
    TRO:"You and Troyes alike are clubs that live with instability, used to the divisions changing beneath your feet. The difference is the cause: you yo-yo because you are an unfashionable battler scrapping every year to survive, while Troyes churns as a development node in a global empire. You yo-yo because you scrap every year to survive, while Troyes churns by design as a cog in a global empire.",
  ...
  PFC:{
    ...
    TRO:"The two of you are clubs built on structure and backing more than on a deep local story. The difference is the scale of the ambition: you are a billionaire-backed bid to become Paris's serious second club, climbing fast, while Troyes is a smaller development outpost content to ride the divisions. You are a billionaire bid to become Paris's serious second club; Troyes is a smaller outpost content to ride the divisions.",
    NIC:"Nice and you are clubs powered by recent money and the hope of mattering, not by inherited passion. The difference is the starting point: Nice has old titles and Riviera glamour to build on, while you are starting almost from scratch, a reborn club with thin history and a brand-new plan. Same bought ambition, one with a past and one without.",
  },
  TRO:{
    ANG:"You and Angers are clubs that live with the divisions shifting beneath you, never settled for long. The difference is the reason: you churn as a development cog in a global empire, talent passing through, while Angers yo-yos because it is an unfashionable battler scrapping to survive. You churn by design as a cog in a global empire; Angers yo-yos because it scraps to survive.",
    ...
    PFC:"The two of you are clubs built on backing and a structured model rather than a deep local roar. The difference is the height of the aim: Paris FC is a billionaire bid to climb fast toward the elite, while you are a modest cog in a global group, content to ride the divisions. Same businesslike soul, one reaching up and one feeding a bigger story.",
  },
  LEM:{
