...
const teams = {
  ...
  TSG: { code3:"TSG", kitType:"solid", secondaryColor:null, name:"TSG Hoffenheim", emoji:"🔵", color:"#1C63B8",
    tagline:"A village put a top-flight team on the map, and you never apologized for the shortcut.",
    desc:"You believe in backing, and in the person willing to put everything behind an idea most people laughed at. A village of a few thousand should not have a Bundesliga team, and yet here you are, because one man believed and built and refused to be told it was impossible. You do not pretend it happened the old, slow way. It happened because of money and conviction, and you are at peace with that. Not every good thing has to be a hundred years old to be real.",
    why:[
      "You value strong backing. The belief and resources behind a project matter to you as much as the project itself.",
      "Your process orientation is high. You trust the plan and the investment to deliver, and they largely have.",
...
const archetypeDesc = {
  ...
  TSG:"You believe in backing and in the person willing to fund an impossible idea. Der Dorfklub, the village club, put a Bundesliga team in a place that had no business holding one, and you are at peace with how.",
...
const teamDims = {
  ...
  "RBL": { loyalty:5, emotion:5, ambition:9, process:9, community:2, chaos:3, rootedness:2 },
  "TSG": { loyalty:5, emotion:4, ambition:6, process:8, community:3, chaos:3, rootedness:4 },
...
const moduleQuestions = [
  { id:"bl_q1", type:"choice", phase:"1", question:"What makes you respect something - a business, a scene, anyone's success?",
  ...
  { id:"bl_q2", type:"choice", phase:"1", question:"At something you love being part of, what's your instinct?",
  ...
  { id:"bl_q3", type:"choice", phase:"1", question:"How do you want to be known for the way you work?",
  ...
  { id:"bl_q4", type:"choice", phase:"1", question:"When things go badly, what do you reach for?",
  ...
  { id:"bl_q5", type:"choice", phase:"1", question:"When you don't like how something's being run, what do you do?",
  ...
  { id:"bl_q6", type:"choice", phase:"1", question:"Thinking about your own life, what are you proudest of?",
  ...
  { id:"bl_q7", type:"choice", phase:"2", question:"Where does your sense of solid ground come from?",
...
const scoring = {
  ...
  bl_q6: { A: cell(["FCU","S04","SCF","KOE","ELV","SCP"]),
           B: cell(["RBL","TSG","B04","BAY"]),
           C: cell(["BVB","VFB","BMG","SVW","M05","FCA","HSV","SGE"]) },
