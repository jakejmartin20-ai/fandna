...
const nearlyGot = {
  ...
  HSV:{
    BMG:"There's real kinship here: you steer by a past that was grander than your present, and you wear that history with pride. The difference is the wound: Gladbach's golden age simply faded, while yours ended in a fall so public it stopped a famous clock. Gladbach's golden age simply faded; yours ended in a fall so public it stopped a clock.",
    S04:"You and Schalke 04 alike are fallen giants with vast, loyal supports who stayed through the lean years. The difference is the texture: Schalke's pride runs through coal and graft and the Ruhr, while yours runs through a Hanseatic port and a record of permanence that finally broke. Schalke's pride runs through coal and the Ruhr, while yours ran through a Hanseatic port and a record of permanence that finally broke.",
    KOE:"The resemblance is real. You have ridden the drop and clawed your way back, and your fans never blinked. The difference is the mood: Köln laughs through the chaos as a carnival, while you carry the fall as a wound to a proud, ever-present record. Köln laughs through the chaos like a carnival. You carry the fall as a wound to a proud, ever-present record.",
  },
  VFB:{
  ...
  BMG:{
    SVW:"Werder Bremen and you are old, loyal clubs whose great days are behind you, carried without bitterness. The difference is the flavor: Bremen's pride is quiet green-and-white continuity, while yours is the swagger of the fearless seventies side that ran Bayern close. Bremen's pride is quiet green-and-white continuity. Yours is the swagger of the seventies side that ran Bayern close.",
    ...
    HSV:"The near-miss makes sense: you steer by a grander past and wear your history proudly. The difference is the wound: your golden age faded gently, while Hamburg's ended in a fall that stopped a famous clock. Your golden age faded gently. Hamburg's ended in a fall that stopped a clock.",
  },
  SVW:{
    ...
    M05:"The two of you are unflashy clubs that ask for very little and stay endlessly loyal. The difference is the temperament: Mainz meets it all with carnival wit, while you meet it with quiet, lifelong constancy. Mainz meets it all with carnival wit; you meet it with quiet, lifelong constancy.",
  ...
  RBL:{
    B04:"You and Bayer Leverkusen are modern, well-run clubs that trust the system and the recruitment over nostalgia. The difference is the welcome: Leverkusen is the long-established works team that the league tolerates, while you are the disruptor it resents. Leverkusen is the works team the league tolerates; you are the disruptor it resents.",
  ...
  B04:{
    RBL:"The two of you are modern, well-run sides that trust the model over the myth. The difference is the welcome: you are the long-established works team the league accepts, while Leipzig is the disruptor it resents. You are the long-established works team the league accepts, while Leipzig is the disruptor it resents.",
    TSG:"TSG Hoffenheim and you are company clubs the traditionalists keep at arm's length. The difference is the payoff: you carried the runner-up label for decades and finally won everything, while Hoffenheim is still the benefactor's project chasing its moment. You carried the runner-up label for decades and finally won everything; Hoffenheim is still the project chasing its moment.",
  ...
  S04:{
    ...
    HSV:"You and Hamburger SV alike are fallen giants whose vast supports never wavered through the drop. The difference is the texture: your pride runs through coal and the Ruhr, while Hamburg's runs through a port and a broken record of permanence. Your pride runs through coal and the Ruhr. Hamburg's runs through a port and a broken record of permanence.",
  },
  BVB:{
    ...
    S04:"The two of you are giant Ruhr clubs whose terraces are the whole point, bound by the Revierderby. The difference is the register: Schalke's pride is the miner's, hard and unglamorous, while yours is pure spectacle, the biggest wall of noise in Europe. Schalke's pride is the miner's, hard and unglamorous, while yours is pure spectacle, the biggest wall of noise in Europe.",
  ...
  SCF:{
    VFB:"First, the kinship. You come from the south-west and trust the patient, properly-built project. The difference is the goal: Stuttgart wants to climb and win, while you measure success by doing it sustainably and right. Stuttgart wants to climb and win; you measure success by doing it sustainably and right.",
    ...
    M05:"Like Mainz 05, you overachieve your means by being smarter and steadier than richer clubs. The difference is the tone: Mainz wraps it in carnival wit, while you wrap it in Black Forest patience and a solar-roofed sense of doing things right. Mainz wraps it in carnival wit. You wrap it in Black Forest patience and a solar-roofed sense of doing things right.",
  },
  FCA:{
    SCP:"You and SC Paderborn are small, modest clubs at peace with punching where you punch, no glory expected. The difference is the ride: Paderborn yo-yos between divisions as an underdog, while you simply stay up, calm and unbothered, year after year. Paderborn yo-yos between divisions as an underdog; you simply stay up, calm and unbothered, year after year.",
    M05:"You and Mainz 05 alike are unglamorous clubs that ask for little and keep your feet on the ground. The difference is the personality: Mainz leans into carnival wit, while you lean into quiet, undramatic survival. Mainz leans into carnival wit, while you lean into quiet, undramatic survival.",
  ...
  KOE:{
    S04:"There's real kinship here: you carry huge working-class followings and a love that asks nothing back. The difference is the mood: you ride the carnival, laughing through every promotion and relegation, while Schalke carries its loyalty like a shift underground, heavier and prouder. You ride the carnival, laughing through every up and down; Schalke carries its loyalty like a shift underground.",
  ...
  M05:{
    ...
    SCP:"You and SC Paderborn are modest clubs that overachieve and refuse to take it too seriously. The difference is the temperament: Paderborn yo-yos as a stubborn underdog, while you survive by being cleverer and funnier than your budget. Paderborn yo-yos as a stubborn underdog, while you survive by being cleverer and funnier than your budget.",
  ...
  ELV:{
    ...
    SCP:"You and SC Paderborn alike are tiny, overlooked clubs that have no business sharing a league with giants. The difference is the story: Paderborn is the seasoned yo-yo underdog, back for another go, while you are the first-time fairytale with everything still ahead. Paderborn is the seasoned yo-yo back for another go; you are the first-time fairytale with everything still ahead.",
  ...
  SCP:{
    M05:"The two of you are modest clubs that overachieve and keep your feet on the ground. The difference is the texture: you yo-yo between divisions as a stubborn underdog, while Mainz survives by carnival wit and cleverness. You yo-yo between divisions as a stubborn underdog; Mainz survives by carnival wit and cleverness.",
    ELV:"SV Elversberg and you are tiny, overlooked clubs improbably sharing a league with giants. The difference is the mileage: you are the seasoned yo-yo side back for another crack, while Elversberg is the wide-eyed first-time fairytale. You are the seasoned yo-yo side back for another crack, while Elversberg is the wide-eyed first-timer.",
  ...
  SGE:{
    ...
    KOE:"You've got genuine overlap. You bring loud, fervent supports that are the whole spectacle. The difference is the spirit: yours is political and defiant, a traveling army, while Köln's is carnival, a city at a party. Yours is political and defiant, a traveling army. Köln's is pure carnival, a whole city at a party.",
