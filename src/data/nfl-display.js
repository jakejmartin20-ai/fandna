// FanDNA - NFL display half (lazy-loaded). Heavy result-stage prose split from nfl.js (s83 code-split A-prime).
// Merged onto SPORT_DATA.NFL via loadSportDisplay(); the engine never reads these.
...
export { teamsCopy, greats, vitalStats, nearlyGot, CARD_BADGES, milestones };
