...
export const spineScoring = {
  S6: { // build - teardown / patient / everything-now / proven
    A: { MIA:2, CWS:2, WSH:2 },
    B: { TB:2, CLE:2, MIL:2, ATH:2, KC:2, BAL:2, MIN:2, DET:2, PIT:2, AZ:2, COL:2, CHC:2, SEA:2, TOR:2 },
    C: { LAD:2, NYM:2, SD:2, PHI:2, HOU:2, TEX:2 },
    D: { NYY:2, STL:2, ATL:2, SF:2, CIN:2, BOS:2, LAA:2 },
  },
  S7: { // role - favourite / underdog / glad-to-be-in / new
    A: { NYY:2, LAD:2, HOU:2, ATL:2, STL:2 },
    B: { TB:2, ATH:2, MIL:2, CLE:2, KC:2, SD:2, NYM:2, CWS:2 },
    C: { CHC:2, PIT:2, SEA:2, CIN:2, DET:2, BAL:2, MIN:2, COL:2, LAA:2, SF:2, PHI:2, TOR:2, BOS:2, TEX:2 },
    D: { MIA:2, AZ:2, WSH:2 },
  },
};
