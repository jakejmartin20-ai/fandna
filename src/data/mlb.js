...
const nearlyGot = {
  "NYY": {
    "LAD": "You and the Dodgers both win and let the whole sport resent you for it, no apology offered. The Dodgers stacked the deck on purpose and said so out loud. For you it was never about buying a title, it is the floor, twenty-seven of them, the measure everyone else is held to. They bought inevitability, and you are the thing inevitability gets compared to.",
  ...
  "CHC": {
    ...
    "PIT": "Pittsburgh asked its fans to keep the faith through a drought the way you did, one most clubs could not survive. Pittsburgh's was a record run of losing seasons watched from the prettiest park around, loyalty tested by an ownership that would not spend. Yours was a hundred and eight years that finally ended on one extra-innings night in 2016. They are still waiting on a payoff, and you already got the one that made all the waiting worth it.",
  ...
  "PIT": {
    ...
    "DET": "Detroit grinds through the hard years the way your city does, fans who never wavered. Detroit's grind is a car city knocked down and climbing back, team and town rising together. Yours is loyalty tested by a record run of losing seasons and an ownership that would not spend, the faith never in question even when the effort was. They are on the way back up, and you kept showing up while the team stood still."
  },
  "SD": {
  ...
  "PHI": {
    ...
    "CWS": "Two working-class clubs that refuse to pretend things are fine when they are not. Chicago's South Side owns the joke, a 1919 scandal and the worst season in modern history, proud to be the half of the city the postcards skip. Yours is the loudest, most unforgiving crowd in the sport, booing its own as a form of love with more losses than any team in pro sports behind it. They take the punchline and keep showing up, and you demand the effort match the noise."
  },
  "DET": {
    ...
    "CWS": "Chicago's South Side wears a chip earned the hard way, the way you do. Chicago's South Side owns rock bottom, the worst season in modern history and a fanbase chanting for the owner to sell, proud to be the part of town the postcards skip. Yours is a car city knocked flat and now climbing back, team and town rising together. They are owning the joke at the bottom, and you are clawing your way up.",
  ...
  "CWS": {
    "CLE": "You and the Guardians are AL Central clubs carrying old wounds and thin recent years. Cleveland's is the longest drought of any team that has won, with the 2016 collapse the cut that lingers; yours is being the sport's punchline, from throwing the 1919 Series to the worst season in modern history, proud to be the half of Chicago the postcards skip. They are haunted by a title they let go, and you own the joke and keep showing up anyway.",
    "DET": "Detroit is a blue-collar Midwest club with a chip earned honestly, the same as you. Detroit is a car city knocked flat and climbing back, team and town rising together. Yours owns rock bottom, the worst season in modern history and fans chanting for the owner to sell, the part of Chicago the postcards skip. They are clawing back up, and you are owning the joke at the floor.",
    "PIT": "Pittsburgh asks its fans to keep the faith through seasons that would break most fanbases, the way you do. Pittsburgh's wound is an ownership that would not spend, a record run of losing seasons watched from a gorgeous park. Yours is being the punchline, the worst season in modern history on the South Side, fans chanting for the owner to sell. Their loyalty is to a team that would not try, and yours is to not being the other team in town.",
  ...
  "BAL": {
    ...
    "CLE": "Cleveland builds around homegrown talent and a belief in the small things, exactly as you do. Cleveland's clever, thrifty machine carries the longest drought of any team that has won, 2016 still aching. Yours is the Oriole Way, fundamentals and reliability under the brick warehouse at the ballpark everyone copied. They are defined by the wait, and you by the creed of showing up every single day.",
  ...
  "MIA": {
    ...
    "SD": "San Diego knows the ache of a roster that never quite gets to stay together, and so do you. San Diego spends like a superpower out of pure want and has reached the final stage twice without a ring. Yours actually won it all twice and tore the team apart for parts both times before the confetti settled. They spend everything and keep missing, and you grabbed it and refused to hold on.",
    "AZ": "Arizona crashed the party fast and won it all early, the same way you did. Arizona took a title in only its fourth year and stayed scrappy and dangerous since. Yours won twice as an upstart and tore the team down for parts both times, a city of beautiful temporary things. They kept building on the win, and you let it slip away on purpose both times.",
  ...
  "TOR": {
    ...
    "BOS": "Boston is a passionate AL East club with titles in its past and heartbreak woven through, the same as you. Boston's was the eighty-six-year curse and the Yankees grudge it finally snapped. Yours is the only team a whole country claims, back-to-back champions in the nineties and then two outs from another in 2025 before it slipped in extra innings. They broke their long wait, and you reopened yours in the cruelest way.",
  ...
  "AZ": {
    ...
    "SD": "San Diego spends like a superpower out of pure want, a different hunger from the one you brought. San Diego spends like a superpower out of pure want and has reached the final stage twice without a ring. Yours grabbed a championship in just its fourth year, the desert upstart that took down the Yankee dynasty. They are still chasing the one they have never held, and you got yours before you had any right to.",
  ...
  "LAA": {
    ...
    "SD": "Two California clubs still chasing what keeps slipping away. San Diego spends like a superpower out of pure want and has reached the final stage twice without a ring. Yours had two of the greatest players alive together and never won an October game with them before one left and won it all elsewhere. They keep spending and missing, and you had it all and let it walk.",
...
export { moduleQuestions, teams, archetypes, teamTextColors, archetypeDesc, greats, vitalStats, milestones, nearlyGot, scoring, teamDims, CARD_BADGES, squadUrls };
