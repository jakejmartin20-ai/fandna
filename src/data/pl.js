...
const teams = {
  ...
  MC: {
    ...
    why:[
      "Your standard is relentless and you trust preparation over inspiration, excellence done deliberately and repeatedly is the whole point.",
      "Your loyalty long predates the success. You were there for the lean years and the lower divisions, and that local faith is the part outsiders never see.",
      "The roots are working-class and they never went anywhere. This is the club of the people who are actually from here.",
    ],
  ...
  NF: {
    ...
    why:[
      "You carry the club's history as living identity. Two European Cups aren't a dusty record, they're the reason, the proof, and the standard you measure today against.",
      "You stayed through decades in the wilderness. The faith never depended on the division, the City Ground was full and loud through all of it.",
      "Your pride comes tinged with longing, immense in what was done, aching at how far it once fell. Both are real and both are yours.",
    ],
...
const nearlyGot = {
  LI:{
    HU:"Both of you live inside the club rather than watch it. Yours is mythology at full volume, European nights and a global Kop. Hull's is narrower, a belonging it once had to physically protect when an owner came for the name. You expect to win. Hull expects to last.",
