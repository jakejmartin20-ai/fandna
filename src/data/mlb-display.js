// FanDNA - MLB display half (lazy-loaded, s83 code-split A'). Heavy result-stage prose
// split from mlb.js; merged onto SPORT_DATA via loadSportDisplay(). The engine never reads these.
...
const milestones = {
  "NYY": [
    "Twenty-seven World Series titles, more than any other team in North American professional sports.",
    "The 1927 Murderers' Row lineup, still called the greatest team the game has ever produced.",
    "Joe DiMaggio's fifty-six-game hitting streak in 1941, a record no one has come close to since.",
    "The heart of the order for generations, from Ruth and Gehrig to Mantle to Jeter.",
    "A five-game loss to the Dodgers in the 2024 World Series, the first Fall Classic in the Bronx since 2009."
  ],
  "LAD": [
    "Back-to-back World Series titles in 2024 and 2025, the first team to repeat in twenty-five years.",
    "Nine championships in all, the ninth clinched in an eleven-inning Game 7 over Toronto.",
    "Jackie Robinson breaking baseball's color line in a Brooklyn uniform in 1947.",
    "Brooklyn's only title in 1955, the Boys of Summer finally beating the Yankees.",
    "Kirk Gibson's limping walk-off home run in the 1988 World Series, an iconic swing."
  ],
  "STL": [
    "Eleven World Series titles, the most of any National League club and second only to the Yankees.",
    "The 2011 crown, taken from a game once a single strike from over, twice, against Texas.",
    "Stan Musial, Bob Gibson, Ozzie Smith, Albert Pujols, a lineage of franchise legends.",
    "The Gashouse Gang of the 1930s, the rowdiest champions the sport had seen.",
    "A fan base so devoted it is widely called the best in baseball."
  ],
  "ATL": [
    "Four World Series titles across three cities, from Boston to Milwaukee to Atlanta.",
    "Fourteen straight division titles from 1991 to 2005, a record run of dominance.",
    "Hank Aaron's 715th home run in 1974, passing Babe Ruth in a Braves uniform.",
    "The 1995 championship, the crown that finally rewarded the era's great pitching staffs.",
    "A young, homegrown 2021 team that caught fire in October and won it all."
  ],
  "SF": [
    "Eight World Series titles, five in New York and three in San Francisco.",
    "Three championships in five years, 2010, 2012 and 2014, all in even years.",
    "Barry Bonds and 762 career home runs, the most anyone has ever hit.",
    "Willie Mays and The Catch in the 1954 World Series, an over-the-shoulder grab for the ages.",
    "The move west from New York in 1958, carrying a century of history to the coast."
  ],
  "CIN": [
    "Baseball's first professional team, the 1869 Red Stockings, the oldest roots in the sport.",
    "Five World Series titles, the last a wire-to-wire sweep in 1990.",
    "The Big Red Machine of the 1970s, back-to-back champions in 1975 and 1976.",
    "Pete Rose and his 4,256 hits, more than any player in history.",
    "Johnny Bench, Joe Morgan, Tony Perez, the everyday core of a dynasty."
  ],
  "CHC": [
    "The 2016 title that ended a 108-year drought, the longest in North American sports history.",
    "A Game 7 won in extra innings over Cleveland, after a rain delay and a blown lead.",
    "Wrigley Field and its ivy walls, home since 1916 and a cathedral of the game.",
    "The Billy Goat curse, blamed for decades of heartbreak until 2016 broke the spell.",
    "Ernie Banks, Mr. Cub, who played nineteen seasons and never reached the postseason."
  ],
  "BOS": [
    "Nine World Series titles, the first in 1903 and the latest in 2018.",
    "The 2004 team that broke the eighty-six-year Curse of the Bambino.",
    "Down three games to none to the Yankees in 2004, then four straight wins, the only such comeback in baseball.",
    "Ted Williams hitting .406 in 1941, the last man to bat .400 for a season.",
    "Fenway Park and the Green Monster, the oldest ballpark in the majors."
  ],
  "CLE": [
    "Two World Series titles, in 1920 and 1948, and nothing since.",
    "The longest active championship drought in baseball, seventy-seven years and counting.",
    "Twenty-two straight wins in 2017, the longest streak the American League has ever seen.",
    "A three-games-to-one lead lost to the Cubs in the 2016 World Series, Game 7 in extra innings.",
    "Larry Doby breaking the American League color line in 1947, weeks after Robinson."
  ],
  "SEA": [
    "The only team in Major League Baseball never to reach a World Series, forty-nine years running.",
    "The 2001 team won 116 games, tied for the most ever, and still missed the World Series.",
    "Edgar Martinez's double in the 1995 division series, the hit credited with saving baseball in Seattle.",
    "Twenty-one straight years without a playoff berth after 2001, ended at last in 2022.",
    "Game 7 of the 2025 ALCS, the closest the franchise has ever come to the Fall Classic."
  ],
  "PIT": [
    "Five World Series titles, the last in 1979 to the anthem We Are Family.",
    "Bill Mazeroski's walk-off home run to win Game 7 in 1960, the first ever to end a World Series.",
    "Roberto Clemente and his 3,000 hits, a Hall of Famer lost far too soon.",
    "Twenty straight losing seasons from 1993 to 2012, the longest such run in major American sports.",
    "Honus Wagner and the early dynasties, roots reaching back to the 1880s."
  ],
  "SD": [
    "No World Series title yet, but two pennants, in 1984 and 1998.",
    "Tony Gwynn and his eight batting titles, a lifetime .338 hitter who never left San Diego.",
    "The 1998 team that won 98 games and reached the Fall Classic before the Yankees swept it.",
    "Trevor Hoffman and the entrance music, six hundred saves to the toll of a bell.",
    "A long wait for a first crown, still chasing it after more than fifty years."
  ],
  "COL": [
    "No World Series title, but one wild pennant run in 2007 called Rocktober.",
    "Twenty-one wins in twenty-two games to reach the 2007 Fall Classic, then a sweep by Boston.",
    "Coors Field and its thin mountain air, where baseballs fly like nowhere else.",
    "Todd Helton, a lifetime Rockie and Hall of Famer, the face of the franchise.",
    "Larry Walker, an MVP and batting champion in the purple pinstripes."
  ],
  "ATH": [
    "Nine World Series titles across Philadelphia and Oakland, a storied and much-moved franchise.",
    "The 1989 Bay Bridge sweep of the Giants, a series interrupted by an earthquake.",
    "Connie Mack, who managed the team for fifty years and built its early dynasties.",
    "The Moneyball era and a twenty-game winning streak in 2002 on the game's smallest budgets.",
    "The Bash Brothers, Reggie Jackson, Rickey Henderson, stars from a rich Oakland history."
  ],
  "TB": [
    "No World Series title, but American League pennants in 2008 and 2020.",
    "A worst-to-first 2008 team that reached the Fall Classic on one of the game's smallest payrolls.",
    "Evan Longoria's rookie heroics, the young star who put the franchise on the map.",
    "A reputation for outsmarting richer rivals year after year on a shoestring budget.",
    "The 2020 pennant, pushed to six games by the Dodgers before falling short."
  ],
  "MIL": [
    "No World Series title, the closest a 1982 loss to the Cardinals in seven games.",
    "Harvey's Wallbangers, the mashing 1982 club that remains the only Brewers pennant winner.",
    "Robin Yount, a two-time MVP who spent all twenty of his seasons in Milwaukee.",
    "A jump from the American League to the National in 1998, a rare switch of leagues.",
    "The 2025 team that took the National League's top seed before a sweep in the NLCS."
  ],
  "MIN": [
    "Three World Series titles, one as the Washington Senators in 1924 and two in Minnesota.",
    "The 1991 championship, ended by a ten-inning Game 7 shutout, one of the greatest ever played.",
    "Kirby Puckett's Game 6 heroics in 1991, telling teammates to jump on his back.",
    "Harmon Killebrew and 573 home runs, the quiet slugger who defined the franchise.",
    "A run of eighteen straight postseason losses, finally broken in 2023."
  ],
  "KC": [
    "Two World Series titles, in 1985 and 2015, thirty years apart.",
    "The 1985 I-70 Series over the Cardinals, sealed after a famous blown call at first.",
    "George Brett, a lifetime Royal and batting champion who once flirted with .400.",
    "Back-to-back pennants in 2014 and 2015, the contact-and-speed teams that ran wild.",
    "The 2015 champions, relentless late-inning comebacks all the way to the crown."
  ],
  "PHI": [
    "Two World Series titles, the first in 1980 after nearly a century of waiting.",
    "The 2008 champions, a title the city held close through the lean years after.",
    "The first franchise in sports to lose 10,000 games, a long and stubborn history.",
    "Mike Schmidt, widely regarded as the finest third baseman the game has produced.",
    "A ballpark famous for its passion, and for booing anything that stands still."
  ],
  "DET": [
    "Four World Series titles, the last a wire-to-wire romp in 1984.",
    "The 1984 team started 35 and 5, one of the great openings in baseball history.",
    "Ty Cobb and a .366 lifetime average, the highest anyone has ever hit.",
    "Al Kaline, Mr. Tiger, who wore the Old English D for twenty-two seasons.",
    "Miguel Cabrera's 2012 Triple Crown, the first in forty-five years."
  ],
  "CWS": [
    "Three World Series titles, in 1906, 1917 and 2005.",
    "The 2005 champions swept the Astros to end an eighty-eight-year drought.",
    "The 1919 Black Sox scandal, eight players banned for throwing the World Series.",
    "Frank Thomas, the Big Hurt, a two-time MVP and the face of the South Side.",
    "A century of baseball on Chicago's South Side, at Comiskey and its successors."
  ],
  "BAL": [
    "Three World Series titles, in 1966, 1970 and 1983.",
    "Cal Ripken Jr. and 2,632 straight games, the Iron Man streak once thought unbreakable.",
    "The 1966 sweep of the Dodgers, allowing just two runs across four games.",
    "Brooks and Frank Robinson, cornerstones of the great teams under Earl Weaver.",
    "A pitching-and-defense tradition known simply as the Oriole Way."
  ],
  "NYM": [
    "Two World Series titles, the Miracle Mets of 1969 and the champions of 1986.",
    "Game 6 in 1986, a ground ball through Bill Buckner's legs that kept the season alive.",
    "An expansion 1962 team that lost 120 games, among the worst seasons ever played.",
    "Tom Seaver, The Franchise, the ace who turned a laughingstock into a champion.",
    "Amazin' comebacks and heartbreak in equal measure, the story of the Mets."
  ],
  "MIA": [
    "Two World Series titles, in 1997 and 2003, both won as a wild card.",
    "A 1997 championship in only the franchise's fifth season, then a roster sold off for parts.",
    "The 2003 upset of the Yankees, a young and fearless team nobody saw coming.",
    "Josh Beckett shutting the door in the Bronx to close out the 2003 title.",
    "Boom-and-bust cycles, two crowns bracketed by long, lean rebuilds."
  ],
  "TOR": [
    "Back-to-back World Series titles in 1992 and 1993, the first crowns won outside the United States.",
    "Joe Carter's walk-off home run to end the 1993 World Series, one of only two in history.",
    "A 2025 return to the Fall Classic, their first pennant in thirty-two years.",
    "A Game 7 loss to the Dodgers in eleven innings in 2025, the title one swing away.",
    "Roberto Alomar and the SkyDome era, a powerhouse north of the border."
  ],
  "TEX": [
    "A first World Series title in 2023, after sixty-two years without one.",
    "An 11 and 0 run on the road that postseason, a perfect October away from home.",
    "One strike away from the crown, twice, in the crushing 2011 World Series loss.",
    "Back-to-back pennants in 2010 and 2011 that ended in heartbreak both times.",
    "Corey Seager's clutch October bat, a two-time World Series MVP."
  ],
  "AZ": [
    "A 2001 World Series title in only the fourth season, the fastest any expansion team has done it.",
    "Luis Gonzalez's walk-off single off Mariano Rivera to win Game 7 over the Yankees.",
    "Randy Johnson and Curt Schilling, co-MVPs who carried the 2001 staff.",
    "A surprise 2023 pennant, back to the World Series before falling to Texas.",
    "The only major professional sports title the state of Arizona has ever won."
  ],
  "WSH": [
    "A first World Series title in 2019, the franchise's only crown.",
    "Every game of that 2019 Series won by the road team, a first in baseball history.",
    "Comebacks in all five elimination games of the 2019 run, again and again.",
    "The Expos roots in Montreal from 1969, before the move to Washington in 2005.",
    "Washington's first baseball champion since the Senators of 1924."
  ],
  "HOU": [
    "Two World Series titles, in 2017 and 2022, the heart of a decade of contention.",
    "Seven straight American League Championship Series from 2017 to 2023.",
    "The 2017 title, later stained by a sign-stealing scandal that shook the sport.",
    "A dominant 2022 championship, redemption for the franchise.",
    "Jeff Bagwell and Craig Biggio, the Killer B's who defined the earlier Astros era."
  ],
  "LAA": [
    "A first and only World Series title in 2002, powered by the Rally Monkey.",
    "A comeback from the brink in Game 6, then Game 7 over the Giants.",
    "Mike Trout, a three-time MVP whose prime passed with barely a playoff game to show.",
    "Shohei Ohtani's two-way brilliance in Anaheim, unanimous MVPs and no October.",
    "Nolan Ryan's no-hitters and hundred-mile-per-hour heat, an early face of the franchise."
  ]
};
...
export { teamsCopy, greats, vitalStats, nearlyGot, milestones, CARD_BADGES };
